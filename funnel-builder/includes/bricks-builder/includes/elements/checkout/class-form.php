...
class Form extends Element {
	...
	public function collapsible_order_summary() {
		...
		$this->add_border_radius( 'wfacp_collapsible_border_radius', array( '#wfacp-e-form .wfacp_mb_mini_cart_wrap .wfacp_mb_cart_accordian', '#wfacp-e-form .wfacp_mb_mini_cart_wrap .wfacp_mb_mini_cart_sec_accordion_content' ), array(), __( 'Border Radius' ) );
	}
