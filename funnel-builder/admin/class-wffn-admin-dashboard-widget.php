				...
				switch ( $app_state ) {
					case 'lite':
                        ...
                        <div class="bwf-widget-notice is-lite">
                            ...
                            <span> <?php echo wp_kses_post( __( 'Get more with FunnelKit PRO—upgrade from Lite for additional features <a href="https://funnelkit.com/exclusive-offer/?utm_source=WordPress&utm_campaign=Lite+Plugin&utm_medium=Dashboard+Widget+TopBar" target="_blank">Upgrade to PRO</a>' ) ); ?></span>
                        </div>
						<?php
						break;
					...
					case 'license_expired':
                        ...
                        <div class="bwf-widget-notice is-danger">
                            ...
                            <span><?php echo wp_kses_post( $all_texts_from_pro['license']['states'][4]['notice']['text'] ); ?> <a href="https://funnelkit.com/exclusive-offer/?utm_source=WordPress&utm_campaign=Lite+Plugin&utm_medium=Dashboard+Widget+TopBar"><?php echo esc_html( $all_texts_from_pro['license']['states'][4]['notice']['primary_action'] ); ?></a></span>
                        </div>
						<?php
						break;
