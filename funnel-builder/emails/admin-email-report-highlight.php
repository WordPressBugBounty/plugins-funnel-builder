...
<table cellpadding="0" cellspacing="0" border="0" bgcolor="" align="center" role="presentation"
    ...
    <tr style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px;">
        <td style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; background-color: <?php echo esc_attr($bg_color); ?>;" 
            bgcolor="<?php echo esc_attr($bg_color); ?>"><!--// @codingStandardsIgnoreLine-->
            <!--[if mso | IE]>
            ...
            <div class="bwfbe-block-section-outer-container"
                 style="margin: 0 auto; width: 640px; background-color: <?php echo esc_attr($bg_color); ?>;">
                <table cellpadding="0" cellspacing="0" border="0" align="center"
                       style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; line-height: normal; background-color: <?php echo esc_attr($bg_color); ?>; width: 100%; border-collapse: separate;"
                       role="presentation" width="100%" class="bwfbe-block-section-inner-container" bgcolor="<?php echo esc_attr($bg_color); ?>">
                    <tbody>
                    <tr
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0"
                                                ...
                                                <tr
                                                    ...
                                                    <td class="bwfbe-btn-text-wrap"
                                                        ...
                                                        bgcolor="<?php echo esc_attr($btn_bg_color); ?>" align="center">
                                                        <a
