		...
		public function show_woofunnels_total_in_order_listings( $column_name, $post_id ) {
			...
			if ( 'order_total' === $column_name ) {
				...
				if ( ! empty( $total_woofunnels ) ) {
					$html = '<br/>
<p style="font-size: 12px;"><em> ' . sprintf( esc_html__( 'FunnelKit: %s', 'funnel-builder' ), wc_price( $total_woofunnels, array( 'currency' => get_option( 'woocommerce_currency' ) ) ) ) . '</em></p>';  // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch, WordPress.WP.I18n.MissingTranslatorsComment
