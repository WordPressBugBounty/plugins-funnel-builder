...
?>
	<!DOCTYPE html>
	<html <?php language_attributes(); ?> class="no-js wfoty_html_canvas">
	<head>
	...
	?>
	<div class="woofunnels-container wfoty-canvas wffn-page-template" <?php echo esc_attr( $attrs_string ); ?>>
		<?php
