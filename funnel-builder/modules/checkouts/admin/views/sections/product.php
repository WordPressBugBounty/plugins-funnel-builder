...
<div id="wfacp_product_container">
	<?php require_once __DIR__ . '/products/no-product-new.php'; ?>
					...
					<div class="wfacp_fsetting_table_head">
						<div class="wfacp_fsetting_table_head_in wfacp_clearfix">
							<div class="wfacp_fsetting_table_title">
								<strong><?php esc_html_e( 'Products', 'woofunnels-aero-checkout' ); ?></strong>
							</div>
							<div class="bwf_ajax_save_buttons bwf_form_submit" v-if="!isEmpty()">
								<span class="wfacp_spinner spinner"></span>
								<a href="javascript:void(0)" class="wfacp_save_btn_style" v-on:click="save_products()"><?php esc_html_e( 'Save Changes', 'woofunnels-aero-checkout' ); ?></a>
							</div>
						</div>
					</div>
					<div class="products_container">
						<?php require_once __DIR__ . '/products/table.php'; ?>
					</div>
...
<?php
require_once __DIR__ . '/products/models.php'
?>
