...
if ( ! class_exists( 'WFACP_Control_Responsive' ) ) {
	/**
	...
	class WFACP_Control_Responsive extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'wfacpkirki-responsive', $uri . 'responsive.js', array( 'jquery', 'customize-base' ), WFACP_VERSION_DEV, true );
			wp_enqueue_style( 'wfacpkirki-responsive-css', $uri . 'responsive.css', null, WFACP_VERSION_DEV );
		}
