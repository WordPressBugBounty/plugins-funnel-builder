...
<div class="wfacp_woocommerce_form_coupon wfacp-form-control-wrapper <?php echo esc_attr( $classes ); ?>" id="order_coupon_field">
			...
			<div class="wfacp-row ">
				<div class="wfacp_coupon_field_msg">
					...
					foreach ( WC()->cart->get_coupons() as $code => $coupon ) {
						...
						printf( '<div class="wfacp_single_coupon_msg">%s</div>', $parse_message );
					}
					?>
				</div>
