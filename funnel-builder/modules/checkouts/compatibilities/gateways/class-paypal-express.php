...
if ( ! class_exists( 'WFACP_Compatibility_With_Paypal_Express' ) ) {
	...
	class WFACP_Compatibility_With_Paypal_Express {
		...
		public function paypal_custom_style() {
            ...
            <style>
                .woocommerce-account-fields {
                    margin: 0 -<?php echo esc_attr( $px ); ?>px;
                }
		...
		public function print_html() {
			?>
            <p>
                <strong><?php esc_html_e( 'Full Name', 'funnel-builder' ); ?></strong> <?php echo esc_html( $this->payer_details ['first_name'] . ' ' . $this->payer_details ['last_name'] ); ?>
            </p>
			<?php
		}
