...
if ( ! class_exists( 'WFACP_Compatibility_WoodMart_Theme' ) ) {
	...
	class WFACP_Compatibility_WoodMart_Theme {
		public function __construct() {
			add_action( 'init', array( $this, 'register_elementor_widget' ), 150 );
			add_action( 'wfacp_after_checkout_page_found', array( $this, 'action' ), 20 );
		...
		public function action() {
			$this->clear_cache();
			add_filter( 'body_class', array( $this, 'remove_class' ) );
			add_action( 'wp_enqueue_scripts', array( $this, 'dequeue_style' ), 9999999 );
