...
if ( ! class_exists( 'WFACP_Plugin_Compatibilities' ) ) {
	...
	class WFACP_Plugin_Compatibilities {
		...
		public static function load_all_compatibilities() {
			...
			add_action( 'plugins_loaded', array( __CLASS__, 'plugin_loaded' ), - 1 );
			add_action( 'after_setup_theme', array( __CLASS__, 'setup_theme' ), - 1 );
			add_action( 'wfacp_template_load', array( __CLASS__, 'template_found' ), - 1 );
		}
		...
		public static function plugin_loaded() {
			$files = array(
				...
				'gateways/class-eps.php'                   => function_exists( 'woocommerce_eps_init' ),
				...
				'gateways/class-woo-payu-payment-gateway.php' => defined( 'PAYU_PLUGIN_VERSION' ),
				'gateways/class-przelewy24-payment-gateway.php' => function_exists( 'woocommerce_p24_add_gateway' ),
				'gateways/class-revolut.php'               => defined( 'WC_GATEWAY_REVOLUT_VERSION' ),
				...
				'plugins/class-woocommerce-dpdfrance.php'  => class_exists( 'OS_dpdfrance_shipping_wrapper' ),
				'plugins/class-cornerstone.php'            => defined( 'CS_VERSION' ),
				'plugins/class-conditional-discounts-for-wc-by-orion.php' => function_exists( 'run_wad' ),
				'plugins/class-customer-reviews-woocommerce.php' => ( class_exists( 'CR_Reviews' ) || defined( 'IVOLE_CONTENT_DIR' ) ) && defined( 'ELEMENTOR_VERSION' ),
				...
				'plugins/class-ecab-taxi-booking-manager.php' => defined( 'MPTBM_PLUGIN_VERSION' ),
				...
				'plugins/class-sonaar-music-pro.php'       => defined( 'SRMP3PRO_VERSION' ), // SRMP3_WooCommerce loads on plugins_loaded:10 (after this -1 check); gate on the early constant, compat re-checks the class at runtime.
				'plugins/class-skyverge-url-coupons.php'   => function_exists( 'wc_url_coupons' ),
				'plugins/class-spectra.php'                => defined( 'UAGB_PLUGIN_NAME' ),
				'plugins/class-template-mela-core.php'     => defined( 'TMCORE_VERSION' ),
				'plugins/class-ti-wishlist.php'            => class_exists( 'TINVWL_URL' ),
				'plugins/class-tm-extra-product-options.php' => class_exists( 'Themecomplete_Extra_Product_Options_Setup' ),
				...
				'plugins/class-weight-based-shipping.php'  => class_exists( '\Wbs\Plugin' ),
				...
				'plugins/class-myparcel-5.php'             => class_exists( '\MyParcelNLWooCommerce' ),
				'plugins/class-jubelio-shipment.php'       => class_exists( 'JubelioShipment' ),
				...
				'plugins/class-woocommerce-address-validation.php' => class_exists( 'WC_Address_Validation_Loader' ),
				...
				'plugins/class-wpforms.php'                => defined( 'WPFORMS_VERSION' ),
				'plugins/class-xlwcty.php'                 => class_exists( 'XLWCTY_Core' ),
				'plugins/class-yaypricing.php'             => defined( 'YAYDP_PLUGIN_FILE' ),
		...
		public static function setup_theme() {
			$files = array(
				...
				'setup-theme/class-brazil-field-2.0.php'   => class_exists( 'Extra_Checkout_Fields_For_Brazil_Front_End' ) || defined( 'WC_BETTER_SHIPPING_CALCULATOR_FOR_BRAZIL_VERSION' ),
				...
				'setup-theme/class-wfacp-webtoffee-gift-cards.php' => class_exists( 'Wt_Woocommerce_Gift_Cards' ),
				...
				'themes/class-rey.php'                     => defined( 'REY_THEME_VERSION' ) || defined( 'REY_CORE_VERSION' ),
				...
				'fields/class-eu-uk-vat-manager-for-wc.php' => ( class_exists( 'WPFactory_WC_EU_VAT' ) || class_exists( 'Alg_WC_EU_VAT' ) ),
				...
				'fields/class-sg-checkout-location-picker-for-wc.php' => function_exists( 'sgitsclp_run_checkout_location_picker' ),
				...
				'fields/class-wfacp-econt-delivery-fields.php' => defined( 'ECONT_PLUGIN_DIR' ) || class_exists( 'Econt_Express' ),
				...
				'fields/class-wfacp-szamlazz-hu.php'       => function_exists( 'WC_Szamlazz' ),
		...
		public static function template_found() {
			$files = array(
				...
				'template-found/class-wp-content-copy-protector.php' => function_exists( 'wccp_main_settings' ),
				...
				'template-found/class-google-captcha-pro.php' => function_exists( 'gglcptch_pro_init' ),
				...
				'template-found/class-magic-login-pro.php' => class_exists( '\MagicLogin\Integrations\WooCommerce' ) || ( function_exists( '\MagicLogin\Utils\get_settings' ) && class_exists( 'WooCommerce' ) ),
				...
				'template-found/class-postcode-eu-address-validation.php' => class_exists( 'PostcodeNl\AddressAutocomplete\Main' ),
				...
				'template-found/class-sendcloud-shipping.php' => class_exists( 'Sendcloud\Shipping\V2\Sendcloud' ) || class_exists( 'SCCSP\SendCloud\Connected\Shipping\SCCSP_Sendcloud' ) || function_exists( 'sendcloudshipping_add_service_point_to_checkout' ),
				...
				'template-found/class-shipping-pickup-point-order-review.php' => class_exists( 'WC_Ps' ) || class_exists( 'Speedy' ),
			);
			self::add_files( $files );
		}
		...
		public static function add_files( $paths ) {
			try {
				...
				if ( defined( 'BWF_DEV' ) && true === BWF_DEV ) {
					trigger_error( esc_html( $e->getMessage() ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ,WordPress.PHP.DevelopmentFunctions.error_log_trigger_error
				}
			}
		}
	}
