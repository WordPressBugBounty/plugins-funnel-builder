...
if ( ! class_exists( 'Oxygen_WFTY_Order_Details_Widget' ) ) {
	...
	class Oxygen_WFTY_Order_Details_Widget extends WFFN_ThankYou_WC_HTML_Block_Oxy {
		...
		protected function register_heading_fields() {
			...
			$this->add_text( $tab_id, 'order_details_heading', __( 'Heading', 'funnel-builder' ), $default_heading );
		...
		protected function register_details_fields() {
			...
			$product_variation_typography = array(
			...
			$product_price_typography = array(
			...
			$subtotal_label_typography = array(
			...
			$subtotal_price_typography = array(
		...
		protected function register_subscription_fields() {
			...
			$this->add_text( $tab_id, 'order_subscription_heading', __( 'Heading', 'funnel-builder' ), $default_heading );
		...
		protected function register_downloads_fields() {
			...
			$this->add_text( $tab_id, 'order_download_heading', __( 'Heading', 'funnel-builder' ), $default_heading );
