...
var abs_component_WFTY_Component = /*#__PURE__*/function (_React$Component) {
  function WFTY_Component() {
    ...
    _this = _callSuper(this, WFTY_Component);
    _this.c_slug = '';
    _this.state = {
      formData: 'Loading ....'
    };
  ...
  return _createClass(WFTY_Component, [{
    key: "render",
...
/* harmony default export */ var abs_component = (abs_component_WFTY_Component);
// CONCATENATED MODULE: ./order-details.js

function order_details_typeof(o) { "@babel/helpers - typeof"; return order_details_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, order_details_typeof(o); }
function order_details_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function order_details_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, order_details_toPropertyKey(o.key), o); } }
function order_details_createClass(e, r, t) { return r && order_details_defineProperties(e.prototype, r), t && order_details_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function order_details_callSuper(t, o, e) { return o = order_details_getPrototypeOf(o), order_details_possibleConstructorReturn(t, order_details_isNativeReflectConstruct() ? Reflect.construct(o, e || [], order_details_getPrototypeOf(t).constructor) : o.apply(t, e)); }
function order_details_possibleConstructorReturn(t, e) { if (e && ("object" == order_details_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return order_details_assertThisInitialized(t); }
function order_details_assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function order_details_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (order_details_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function order_details_getPrototypeOf(t) { return order_details_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, order_details_getPrototypeOf(t); }
function order_details_inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && order_details_setPrototypeOf(t, e); }
function order_details_setPrototypeOf(t, e) { return order_details_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, order_details_setPrototypeOf(t, e); }
function order_details_defineProperty(e, r, t) { return (r = order_details_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function order_details_toPropertyKey(t) { var i = order_details_toPrimitive(t, "string"); return "symbol" == order_details_typeof(i) ? i : i + ""; }
function order_details_toPrimitive(t, r) { if ("object" != order_details_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != order_details_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var order_details_WFTY_Order_Details = /*#__PURE__*/function (_WFTY_Component) {
  function WFTY_Order_Details() {
    ...
    _this = order_details_callSuper(this, WFTY_Order_Details);
    _this.c_slug = 'et_wfty_order_details';
    return _this;
  }
  order_details_inherits(WFTY_Order_Details, _WFTY_Component);
  return order_details_createClass(WFTY_Order_Details, [{
    key: "render",
    value: function render() {
...
/* harmony default export */ var order_details = (order_details_WFTY_Order_Details);
// CONCATENATED MODULE: ./customer-details.js

function customer_details_typeof(o) { "@babel/helpers - typeof"; return customer_details_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, customer_details_typeof(o); }
function customer_details_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function customer_details_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, customer_details_toPropertyKey(o.key), o); } }
function customer_details_createClass(e, r, t) { return r && customer_details_defineProperties(e.prototype, r), t && customer_details_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function customer_details_callSuper(t, o, e) { return o = customer_details_getPrototypeOf(o), customer_details_possibleConstructorReturn(t, customer_details_isNativeReflectConstruct() ? Reflect.construct(o, e || [], customer_details_getPrototypeOf(t).constructor) : o.apply(t, e)); }
function customer_details_possibleConstructorReturn(t, e) { if (e && ("object" == customer_details_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return customer_details_assertThisInitialized(t); }
function customer_details_assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function customer_details_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (customer_details_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function customer_details_getPrototypeOf(t) { return customer_details_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, customer_details_getPrototypeOf(t); }
function customer_details_inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && customer_details_setPrototypeOf(t, e); }
function customer_details_setPrototypeOf(t, e) { return customer_details_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, customer_details_setPrototypeOf(t, e); }
function customer_details_defineProperty(e, r, t) { return (r = customer_details_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function customer_details_toPropertyKey(t) { var i = customer_details_toPrimitive(t, "string"); return "symbol" == customer_details_typeof(i) ? i : i + ""; }
function customer_details_toPrimitive(t, r) { if ("object" != customer_details_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != customer_details_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var customer_details_WFTY_Customer_Details = /*#__PURE__*/function (_WFTY_Component) {
  function WFTY_Customer_Details() {
    ...
    _this = customer_details_callSuper(this, WFTY_Customer_Details);
    _this.c_slug = 'et_wfty_customer_details';
    return _this;
  }
  customer_details_inherits(WFTY_Customer_Details, _WFTY_Component);
  return customer_details_createClass(WFTY_Customer_Details, [{
    key: "render",
    value: function render() {
...
/* harmony default export */ var customer_details = (customer_details_WFTY_Customer_Details);
