...
?>
    ...
    <!DOCTYPE html>
    <html <?php language_attributes(); ?> class="no-js wftp_html_boxed">
    <head>
    ...
    <body <?php body_class(); ?> class="wftp-boxed">
	...
	?>
    <div class="woofunnels-container wftp-boxed wffn-page-template" <?php echo esc_attr( $attrs_string ); ?>>
